...
async function fetchEvidence(question) {
    ...
    const evidence = { sources: [], confidence: 60 };
    ...
    for (const m of resolved) {
        ...
        await prisma.dispute.create({
            data: {
                ...
                evidenceHash: ethers.keccak256(ethers.toUtf8Bytes(JSON.stringify({ question: m.question, sources: evidence.sources, t: Date.now() }))),
                stake: '0',
                status: 'active',
